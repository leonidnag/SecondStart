    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costumer_name', models.CharField(blank=True, default=None, max_length=64, null=True)),
                ('customer_email', models.EmailField(blank=True, default=None, max_length=254, null=True)),
                ('costumer_phone', models.CharField(blank=True, default=None, max_length=48, null=True)),
                ('costumer_address', models.CharField(blank=True, default=None, max_length=128, null=True)),
